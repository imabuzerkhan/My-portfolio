...
<FaPhoneAlt  className="bg-white px-3 py-3 text-[#1eac9e] rounded-full text-7xl  "  />
...
<MdOutgoingMail  className="bg-white px-3 py-3 text-[#1eac9e] rounded-full text-7xl "  />
<div className="Gmail-text flex  flex-col ">
 ...
 <div className="Contact-Gmail flex items-center justify-center gap-3 ">
<FaAddressBook  className="bg-white px-3 py-3 text-[#1eac9e] rounded-full text-7xl  "  />
<div className="Gmail-text flex  flex-col ">
