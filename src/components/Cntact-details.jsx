...
<FaPhoneAlt  className="bg-white px-4 py-4 text-7xl lg:px-3 lg:py-3 text-[#1eac9e] rounded-full lg:text-5xl  "  />
...
<MdOutgoingMail  className="bg-white px-4 py-4 lg:px-3 lg:py-3 text-[#1eac9e] rounded-full text-7xl lg:text-5xl "  />
<div className="Gmail-text flex  flex-col ">
 ...
 <div className="Contact-Gmail flex items-center justify-center gap-3 ">
<FaAddressBook  className="bg-white px-4 py-4 lg:px-3 lg:py-3 text-[#1eac9e] rounded-full lg:text-5xl text-7xl  "  />
<div className="Gmail-text flex  flex-col ">
